...
root = Tk()
root.geometry("925x550+100+30")
root.title("Sylvian's File Manager")
...
lbl_heading = Label(root, text="Sylvian's File Manager",font=("bold",18),fg="dark red",bg='black')
lbl_heading.grid(row=1, column=1, pady=20, padx=20)

lbl_heading = Label(root, text="Contact me: Centralized#6346",font=("bold",10),fg="dark red",bg='black')
lbl_heading.grid(row=6, column=0, pady=10, padx=10)
...
exit_btn = Button(root, text="Exit", command=root.destroy, width=15,font=('bold',14))
exit_btn.grid(row=4, column=0, pady=10, padx=20)
